...
public class CalculatorFormServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        double number = Double.parseDouble(request.getParameter("fahrenheit"));
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h3>"+number+" Fahrenheit = "+ calculatorBean.cal(number) + " Celsius</h3>");
            out.println("</body>");
            out.println("</html>");
        }
    }
